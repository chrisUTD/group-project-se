...
public final class GroupContract {
    ...
    public static abstract class ContactToGroup implements BaseColumns {
        ...
        public static final String COLUMN_NAME_CONTACT_LOOKUP_KEY = "lookup_key";
    }

    /**
     * SQL Command to create the Group table if it has not already been created.
     */
    private static final String SQL_CREATE_GROUP_TABLE =
            "CREATE TABLE IF NOT EXIST" + Group.TABLE_NAME + " (" +
     ...
     */
    private static final String SQL_PREPOPULATE_GROUP_TABLE =
     ...
     */
    private static final String SQL_CREATE_CONTACT_TO_GROUP_TABLE =
            "CREATE TABLE IF NOT EXIST" + ContactToGroup.TABLE_NAME + " (" +
                    ContactToGroup._ID + " INTEGER PRIMARY KEY," +
                    ContactToGroup.COLUMN_NAME_CONTACT_ID + " TEXT" +
                    ContactToGroup.COLUMN_NAME_CONTACT_LOOKUP_KEY + " TEXT" +
